...
#import "TRZXMarketViewController.h"
...
@interface TRZXMarketViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TRZXMarketViewController
...
-(void)marketTradingCenterViewWithBlock:(MarketCollectionViewCellType)type{
    ...
    switch (type) {
        ...
        case MarketCollectionViewCellTypeNearShareholders:{//附近股东
            UIViewController *projectPageController = [[CTMediator sharedInstance] mapHomeViewController:@"地图"];
            if (projectPageController) {
                [self.navigationController pushViewController:projectPageController animated:YES];
            }
